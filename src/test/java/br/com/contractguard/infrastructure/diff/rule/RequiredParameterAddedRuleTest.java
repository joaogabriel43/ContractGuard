...
class RequiredParameterAddedRuleTest {
  ...
  private OpenAPI parse(String filename) throws IOException {
    var stream =
        Objects.requireNonNull(
            getClass().getResourceAsStream("/specs/" + filename), "Fixture not found: " + filename);
  ...
  @Test
  @DisplayName(
      "GIVEN required 'status' param added to GET /pets WHEN evaluate THEN one BREAKING violation")
