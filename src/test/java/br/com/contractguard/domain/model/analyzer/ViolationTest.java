...
class ViolationTest {
  ...
  class Creation {
    ...
    @Test
    @DisplayName(
        "GIVEN null httpMethod WHEN Violation.of THEN creates violation (httpMethod is optional)")
    ...
    void should_not_be_breaking_when_severity_is_warning() {
      var v =
          Violation.of(
              "/users",
              "GET",
              ViolationType.SECURITY_SCHEME_CHANGED,
    ...
    void should_not_be_breaking_when_severity_is_info() {
      var v =
          Violation.of(
              "/users",
              "GET",
              ViolationType.DESCRIPTION_CHANGED,
  ...
  class Validation {
    ...
    void should_throw_when_type_is_null() {
      assertThatThrownBy(
              () -> Violation.of("/pets", "GET", null, ViolationSeverity.BREAKING, "msg"))
          .isInstanceOf(DomainException.class)
    ...
    void should_throw_when_severity_is_null() {
      assertThatThrownBy(
              () -> Violation.of("/pets", "GET", ViolationType.ENDPOINT_REMOVED, null, "msg"))
          .isInstanceOf(DomainException.class)
