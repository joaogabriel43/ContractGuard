...
class AnalyzerControllerTest {
  ...
  @MockBean private AnalyzeContractUseCase analyzeContractUseCase;
    ...
    mockMvc
        .perform(
            org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get(
                    "/api/v1/services/pet-store/reports/latest")
  ...
  void should_analyze_and_return_200() throws Exception {
    ...
    mockMvc
        .perform(
            post("/api/v1/services/pet-store/analyze")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonRequest))
        .andExpect(status().isOk())
  ...
  void should_return_400_when_domain_exception() throws Exception {
    ...
    mockMvc
        .perform(
            post("/api/v1/services/unknown/analyze")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonRequest))
        .andExpect(status().isBadRequest())
