 ...
 *
 * <ul>
 *   <li>{@link #BREAKING} — the change is incompatible and will break existing consumers. CI/CD
 *       pipelines must fail when this is detected.
 *   <li>{@link #WARNING} — the change is potentially problematic but not necessarily fatal.
 *       Requires human review before merging.
 *   <li>{@link #INFO} — the change is backward-compatible and purely informational (e.g., a new
 *       endpoint or an optional parameter was added).
 * </ul>
 */
