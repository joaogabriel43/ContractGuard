...
public class DiffReport {
  ...
  private DiffReport(
    ...
    Objects.requireNonNull(
        candidateApiSpecificationId, "DiffReport candidateApiSpecificationId must not be null");
    Objects.requireNonNull(
        candidateSpecVersion, "DiffReport candidateSpecVersion must not be null");
  ...
  public static DiffReport createWithoutBaseline(
      UUID serviceId, UUID candidateApiSpecificationId, String candidateSpecVersion) {
    return new DiffReport(
        UUID.randomUUID(),
        serviceId,
        null,
  ...
  public static DiffReport reconstitute(
      UUID id,
      UUID serviceId,
      UUID baseApiSpecificationId,
      UUID candidateApiSpecificationId,
  ...
  public List<Violation> getBreakingViolations() {
    return violations.stream().filter(Violation::isBreaking).toList();
  }
