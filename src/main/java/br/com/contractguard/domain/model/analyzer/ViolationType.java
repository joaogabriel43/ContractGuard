 ...
 *
 * <p>Each type carries a {@link #getDefaultSeverity()} that represents the canonical severity for
 * that change. The diff engine may override the severity based on additional context, but the
 * default serves as the baseline for classification.
 *
 * <p><strong>Breaking changes</strong>: removals, type incompatibilities, new required constraints.
 * <br>
...
public enum ViolationType {
  ...
  /**
   * An existing parameter was removed. Consumers passing it will have their calls ignored or
   * rejected.
   */
  ...
  /**
   * Returns the canonical severity for this type of violation. The diff engine may override this
   * based on context.
   */
