...
public interface AnalyzeContractUseCase {
  ...
  /**
   * Orchestrates the analysis flow: 1. Finds the service by slug. 2. Uploads and saves the new
   * candidate specification. 3. Finds the latest baseline specification (if any). 4. Runs the diff
   * engine to generate a report. 5. Saves the report and violations.
   *
   ...
   * @throws br.com.contractguard.domain.exception.DomainException if service not found, version
   *     duplicate, or spec invalid
   */
