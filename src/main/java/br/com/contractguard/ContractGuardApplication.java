 ...
 *
 * <p>Entry point of the Spring Boot application. All configuration is loaded from {@code
 * application.yml} (and profile-specific overrides like {@code application-local.yml}).
 *
